      ...
      tabItem(tabName = "cluster_comparison",
              ...
              box(
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    selectInput(
                      "coexpr_plot_type",
                      "Visualization:",
                      choices = c("Stacked Bar" = "bar", "Heatmap" = "heat"),
                      selected = "bar"
                    ),
                    downloadButton("download_coexpression_table_single", "Download Table"),
                    downloadButton("download_coexpression_plot_single", "Download Plot")
                  )
                ),
                ...
                tabsetPanel(
                  tabPanel(
                    "Results Table",
                    DTOutput("gene_coexpression_table_single")
                  ),
                  tabPanel(
                    "Visualization",
                    plotOutput("gene_coexpression_plot_single", height = "500px")
                  )
                )
              )
